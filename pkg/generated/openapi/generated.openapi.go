...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/ntlaletsi70/blanketops-environments-api/api/events/v1alpha1.GitHubEvent":       schemaSimpleObject("GitHubPayload"),
		"github.com/ntlaletsi70/blanketops-environments-api/api/events/v1alpha1.GitHubEventList":   schemaSimpleObject("GitHubPayloadList"),
		"github.com/ntlaletsi70/blanketops-environments-api/api/events/v1alpha1.GitHubEventSpec":   schemaSimpleObject("GitHubPayloadSpec"),
		"github.com/ntlaletsi70/blanketops-environments-api/api/events/v1alpha1.GitHubEventStatus": schemaSimpleObject("GitHubPayloadStatus"),
